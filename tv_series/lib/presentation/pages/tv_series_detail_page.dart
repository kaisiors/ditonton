...
import 'package:tv_series/presentation/bloc/detail/detail_cubit.dart';
...
class _TvSeriesDetailPageState extends State<TvSeriesDetailPage> {
  ...
  void initState() {
    super.initState();
    context.read<DetailTvSeriesCubit>().getDetail(widget.id);
    context.read<RecommendationTvSeriesCubit>().getData(widget.id);
    context.read<WatchlistTvSeriesCubit>().getStatus(widget.id);
  }

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: BlocBuilder<DetailTvSeriesCubit, DetailTvSeriesState>(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 16),
                            ElevatedButton(
                              key: const Key('episode_guide'),
                              onPressed: () => Navigator.pushNamed(
                                context,
                                EpisodePage.ROUTE_NAME,
                                arguments: EpisodeArgument(
                                  id: tvSeries.id,
                                  seasons: tvSeries.seasons,
                                ),
                              ),
                              child: const Text('Episode Guide'),
                            ),
                            const SizedBox(height: 16),
                            Text(
                              'Recommendations',
                            ...
                            BlocBuilder<RecommendationTvSeriesCubit,
